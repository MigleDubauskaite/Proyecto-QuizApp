	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http
				...
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers("/api/auth/**", "/api/movil/**", "/v3/api-docs/**", "/swagger-ui/**","/swagger-ui.html").permitAll()
						...
						// Al usar solo /api/preguntas/** sin especificar método, bloqueamos el resto
						// para Admin
